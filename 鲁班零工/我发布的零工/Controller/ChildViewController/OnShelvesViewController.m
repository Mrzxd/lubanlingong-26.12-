...
@interface OnShelvesViewController () <UITableViewDelegate,UITableViewDataSource>
...
@implementation OnShelvesViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WeakSelf;
       ...
       if ([weakCell.MiddleButton.currentTitle isEqual:@"下架"]) {
           [ZXD_NetWorking postWithUrl:[rootUrl stringByAppendingFormat:weakSelf.isService?@"/CoreInfo/takeOff":@"/CoreInfo/takeOffWork"] params:@{@"id":NoneNull(model.idName)} success:^(id  _Nonnull response){
