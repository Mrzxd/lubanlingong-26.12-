...
@interface EmployeeCentreController ()

@property (nonatomic, strong) UIView *headerView;

@end

@implementation EmployeeCentreController
...
- (void)addBottomWhiteView {
    ...
    NSArray *imageArray = @[@"employer_publish",@"red_form"];
    for (NSInteger i = 0; i < 2; i ++) {
        ...
        NSArray *typeArray = @[@"我发布的服务",@"我接的零工"];
...
- (void)buttonAction:(UIButton *)button {
    if (button.tag == 500) {
        ...
        [self.navigationController pushViewController:[MyOddJobController new] animated:YES];
    }
}
