...
- (void)viewWillLayoutSubviews {
    ...
    if (self.segmentBar.superview == self.view) {
        self.segmentBar.frame = CGRectMake(0, self.segmentBar.y,self.scrollView.width, self.segmentBar.height);
...
- (YTSegmentBar *)segmentBar {
    if (!_segmentBar) {
        _segmentBar = [YTSegmentBar segmentBarWithFrame:CGRectMake(0, 100, 0, 0)];
