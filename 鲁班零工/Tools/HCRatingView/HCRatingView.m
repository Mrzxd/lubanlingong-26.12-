...
-(void) setImagesDeselected:(NSString *)unSelectedImage partlySelected:(NSString *)partlySelectedImage fullSelected:(NSString *)fullSelectedImage
     userInteractionEnabled:(BOOL) userInteractionEnable andDelegate:(id<HCRatingViewDelegate>)delegate {
    ...
    _mS1.contentMode = UIViewContentModeScaleAspectFit;
    _mS2.contentMode = UIViewContentModeScaleAspectFit;
    _mS3.contentMode = UIViewContentModeScaleAspectFit;
    _mS4.contentMode = UIViewContentModeScaleAspectFit;
    _mS5.contentMode = UIViewContentModeScaleAspectFit;
    ...
    [_mS1 setUserInteractionEnabled:userInteractionEnable];
    [_mS2 setUserInteractionEnabled:userInteractionEnable];
    [_mS3 setUserInteractionEnabled:userInteractionEnable];
    [_mS4 setUserInteractionEnabled:userInteractionEnable];
    [_mS5 setUserInteractionEnabled:userInteractionEnable];
