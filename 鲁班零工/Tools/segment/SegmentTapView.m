...
#define DefaultTextNomalColor RGBHex(0xcccccc)
#define DefaultTextSelectedColor RGBHex(0xCFA25E)
#define DefaultLineColor [UIColor redColor]
#define DefaultTitleFont 15 *ScalePpth
#define LineHeigh 1
...
- (void)setSelectedIndex:(int)index {
    for (int i = 0; i < self.buttonsArray.count; i ++) {
        UIButton *subButton = _buttonsArray[i];
        if (i == index) {
