...
+ (void)showSuccessWithMessage:(NSString *)message {
     [[self sharedInstance] showToastWithType:WHToastTypeSuccess Message:message originY:0 image:nil duration:1.8 finishHandler:nil];
}
+(void)showErrorWithMessage:(NSString *)message {
    [[self sharedInstance] showToastWithType:WHToastTypeError Message:message originY:0 image:nil duration:1.9 finishHandler:nil];
}
