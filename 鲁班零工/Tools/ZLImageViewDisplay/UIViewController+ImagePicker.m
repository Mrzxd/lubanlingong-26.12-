...
static void const *kImagePickerCompletionHandlerKey = @"kImagePickerCompletionHandlerKey";
static void const *kCameraPickerKey = @"kCameraPickerKey";
static void const *kPhotoLibraryPickerKey = @"kPhotoLibraryPickerKey";
static void const *kImageSizeKey = @"kimageSizeKey";
static void const *isCut =  @"isCut"; //截取
...
//        NSLog(@"图片超过1M 压缩imageData.length ===== %ld",imageData.length);
