...
- (void)setUpUI {
    ...
    UILabel *remindContentLabel = [[UILabel alloc] initWithFrame:AutoFrame(14, 43, 0, 0)];
    ...
    UILabel *timeLabel = [[UILabel alloc] initWithFrame:AutoFrame(8, 15, 100, 14)];
    ...
    UILabel *timeContentLabel = [[UILabel alloc] initWithFrame:AutoFrame(14, 136, 0, 0)];
    ...
    timeContentLabel.text = @"工作时间根据自身实际情况而定，24小时可做";
    ...
    UILabel *placeLabel = [[UILabel alloc] initWithFrame:AutoFrame(8, 15, 100, 14)];
    ...
    UILabel *placeContentLabel = [[UILabel alloc] initWithFrame:AutoFrame(14, 136, 0, 0)];
    ...
    placeContentLabel.text = @"全市区可做，市区内商圈，就近分配";
